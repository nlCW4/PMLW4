...
After a little help, I did everything from scratch, removed also the columns containing X, name or timestamp that weren't very useful for accelerometer data measurement, and I chose a 5 fold cross-validation.Here's the new results I obtained on the testing dataset:
